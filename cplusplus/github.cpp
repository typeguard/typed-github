...
namespace quicktype {
    ...
    struct License {
        std::string key;
        std::string name;
        std::unique_ptr<std::string> spdx_id;
    ...
    enum class Type { APPLICATION_JSON, APPLICATION_X_SH, TEXT_PLAIN, TEXT_TAB_SEPARATED_VALUES };
    ...
    struct Files {
        std::unique_ptr<struct Empty> gistfile1_txt;
        std::unique_ptr<struct Empty> ruwikiruscorpora_upos_skipgram_300_2_2018__b2_b090_a678_a3_d66_b62_ddf890_eefe5_f26_config_json;
        std::unique_ptr<struct Empty> ruwikiruscorpora_upos_skipgram_300_2_2018__b2_b090_a678_a3_d66_b62_ddf890_eefe5_f26_metadata_tsv;
        std::unique_ptr<struct Empty> ruwikiruscorpora_upos_skipgram_300_2_2018__b2_b090_a678_a3_d66_b62_ddf890_eefe5_f26_tensor_tsv;
        std::unique_ptr<struct Empty> config_json;
        std::unique_ptr<struct Empty> empty;
        std::unique_ptr<struct Empty> the_6_mn_u_zy7_z;
        std::unique_ptr<struct Empty> le_dbreathe_ino;
        std::unique_ptr<struct Empty> i3_blocks_spotify;
        std::unique_ptr<struct Empty> readme_md;
        std::unique_ptr<struct Empty> decrypt_file_sh;
        std::unique_ptr<struct Empty> encrypt_file_sh;
        std::unique_ptr<struct Empty> limited_no_of_records_java;
        std::unique_ptr<struct Empty> client_app;
        std::unique_ptr<struct Empty> server_ap;
        std::unique_ptr<struct Empty> ruwikiruscorpora_upos_skipgram_300_2_2018__fafdb1_f6_d6866_fb229_e806_fc354_b7458_config_json;
    };
...
namespace nlohmann {
    ...
    inline void from_json(const json& _j, struct quicktype::Comment& _x) {
        _x.url = _j.at("url").get<std::string>();
        _x.pull_request_review_id = _j.at("pull_request_review_id").get<int64_t>();
        _x.id = _j.at("id").get<int64_t>();
        _x.diff_hunk = _j.at("diff_hunk").get<std::string>();
        _x.path = _j.at("path").get<std::string>();
        _x.position = _j.at("position").get<int64_t>();
        _x.original_position = _j.at("original_position").get<int64_t>();
        _x.commit_id = _j.at("commit_id").get<std::string>();
        _x.original_commit_id = _j.at("original_commit_id").get<std::string>();
        ...
        _x.html_url = _j.at("html_url").get<std::string>();
        _x.pull_request_url = _j.at("pull_request_url").get<std::string>();
        _x.author_association = _j.at("author_association").get<std::string>();
        _x.links = _j.at("_links").get<struct quicktype::CommentLinks>();
    }
    ...
    inline void from_json(const json& _j, struct quicktype::License& _x) {
        ...
        _x.name = _j.at("name").get<std::string>();
        _x.spdx_id = quicktype::get_optional<std::string>(_j, "spdx_id");
        _x.url = quicktype::get_optional<std::string>(_j, "url");
    }
    ...
    inline void from_json(const json& _j, struct quicktype::Empty& _x) {
    ...
    inline void to_json(json& _j, const struct quicktype::Empty& _x) {
        _j = json::object();
    ...
    inline void from_json(const json& _j, struct quicktype::Files& _x) {
        _x.gistfile1_txt = quicktype::get_optional<struct quicktype::Empty>(_j, "gistfile1.txt");
        _x.ruwikiruscorpora_upos_skipgram_300_2_2018__b2_b090_a678_a3_d66_b62_ddf890_eefe5_f26_config_json = quicktype::get_optional<struct quicktype::Empty>(_j, "ruwikiruscorpora_upos_skipgram_300_2_2018_b2b090a678a3d66b62ddf890eefe5f26_config.json");
        _x.ruwikiruscorpora_upos_skipgram_300_2_2018__b2_b090_a678_a3_d66_b62_ddf890_eefe5_f26_metadata_tsv = quicktype::get_optional<struct quicktype::Empty>(_j, "ruwikiruscorpora_upos_skipgram_300_2_2018_b2b090a678a3d66b62ddf890eefe5f26_metadata.tsv");
        _x.ruwikiruscorpora_upos_skipgram_300_2_2018__b2_b090_a678_a3_d66_b62_ddf890_eefe5_f26_tensor_tsv = quicktype::get_optional<struct quicktype::Empty>(_j, "ruwikiruscorpora_upos_skipgram_300_2_2018_b2b090a678a3d66b62ddf890eefe5f26_tensor.tsv");
        _x.config_json = quicktype::get_optional<struct quicktype::Empty>(_j, "config.json");
        _x.empty = quicktype::get_optional<struct quicktype::Empty>(_j, "-");
        _x.the_6_mn_u_zy7_z = quicktype::get_optional<struct quicktype::Empty>(_j, "6mnUZy7z");
        _x.le_dbreathe_ino = quicktype::get_optional<struct quicktype::Empty>(_j, "LEDbreathe.ino");
        _x.i3_blocks_spotify = quicktype::get_optional<struct quicktype::Empty>(_j, "i3blocks-spotify");
        _x.readme_md = quicktype::get_optional<struct quicktype::Empty>(_j, "_README.md");
        _x.decrypt_file_sh = quicktype::get_optional<struct quicktype::Empty>(_j, "decryptFile.sh");
        _x.encrypt_file_sh = quicktype::get_optional<struct quicktype::Empty>(_j, "encryptFile.sh");
        _x.limited_no_of_records_java = quicktype::get_optional<struct quicktype::Empty>(_j, "limitedNoOfRecords.java");
        _x.client_app = quicktype::get_optional<struct quicktype::Empty>(_j, "CLIENT APP");
        _x.server_ap = quicktype::get_optional<struct quicktype::Empty>(_j, "SERVER AP");
        _x.ruwikiruscorpora_upos_skipgram_300_2_2018__fafdb1_f6_d6866_fb229_e806_fc354_b7458_config_json = quicktype::get_optional<struct quicktype::Empty>(_j, "ruwikiruscorpora_upos_skipgram_300_2_2018_fafdb1f6d6866fb229e806fc354b7458_config.json");
    }

    inline void to_json(json& _j, const struct quicktype::Files& _x) {
        _j = json::object();
        _j["gistfile1.txt"] = _x.gistfile1_txt;
        _j["ruwikiruscorpora_upos_skipgram_300_2_2018_b2b090a678a3d66b62ddf890eefe5f26_config.json"] = _x.ruwikiruscorpora_upos_skipgram_300_2_2018__b2_b090_a678_a3_d66_b62_ddf890_eefe5_f26_config_json;
        _j["ruwikiruscorpora_upos_skipgram_300_2_2018_b2b090a678a3d66b62ddf890eefe5f26_metadata.tsv"] = _x.ruwikiruscorpora_upos_skipgram_300_2_2018__b2_b090_a678_a3_d66_b62_ddf890_eefe5_f26_metadata_tsv;
        _j["ruwikiruscorpora_upos_skipgram_300_2_2018_b2b090a678a3d66b62ddf890eefe5f26_tensor.tsv"] = _x.ruwikiruscorpora_upos_skipgram_300_2_2018__b2_b090_a678_a3_d66_b62_ddf890_eefe5_f26_tensor_tsv;
        _j["config.json"] = _x.config_json;
        _j["-"] = _x.empty;
        _j["6mnUZy7z"] = _x.the_6_mn_u_zy7_z;
        _j["LEDbreathe.ino"] = _x.le_dbreathe_ino;
        _j["i3blocks-spotify"] = _x.i3_blocks_spotify;
        _j["_README.md"] = _x.readme_md;
        _j["decryptFile.sh"] = _x.decrypt_file_sh;
        _j["encryptFile.sh"] = _x.encrypt_file_sh;
        _j["limitedNoOfRecords.java"] = _x.limited_no_of_records_java;
        _j["CLIENT APP"] = _x.client_app;
        _j["SERVER AP"] = _x.server_ap;
        _j["ruwikiruscorpora_upos_skipgram_300_2_2018_fafdb1f6d6866fb229e806fc354b7458_config.json"] = _x.ruwikiruscorpora_upos_skipgram_300_2_2018__fafdb1_f6_d6866_fb229_e806_fc354_b7458_config_json;
    }
    ...
    inline void from_json(const json& _j, struct quicktype::Gist& _x) {
        ...
        _x.html_url = _j.at("html_url").get<std::string>();
        _x.files = _j.at("files").get<struct quicktype::Files>();
        _x.purple_public = _j.at("public").get<bool>();
        _x.created_at = _j.at("created_at").get<std::string>();
        _x.updated_at = _j.at("updated_at").get<std::string>();
        _x.description = quicktype::get_optional<std::string>(_j, "description");
    ...
    inline void from_json(const json& _j, quicktype::Type& _x) {
        if (_j == "application/json") _x = quicktype::Type::APPLICATION_JSON;
        else if (_j == "application/x-sh") _x = quicktype::Type::APPLICATION_X_SH;
        else if (_j == "text/plain") _x = quicktype::Type::TEXT_PLAIN;
        else if (_j == "text/tab-separated-values") _x = quicktype::Type::TEXT_TAB_SEPARATED_VALUES;
        else throw "Input JSON does not conform to schema";
    }

    inline void to_json(json& _j, const quicktype::Type& _x) {
        switch (_x) {
            case quicktype::Type::APPLICATION_JSON: _j = "application/json"; break;
            case quicktype::Type::APPLICATION_X_SH: _j = "application/x-sh"; break;
            case quicktype::Type::TEXT_PLAIN: _j = "text/plain"; break;
            case quicktype::Type::TEXT_TAB_SEPARATED_VALUES: _j = "text/tab-separated-values"; break;
            default: throw "This should not happen";
        }
    }
